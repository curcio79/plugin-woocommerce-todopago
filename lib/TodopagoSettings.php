		...
		$settings = apply_filters( 'woocommerce_settings-todopago',
			...
			'options' => array(
				...
				'user_dev' => array(
					'title'       => 'Usuario',
					'type'        => 'text',
					'description' => 'Usuario de Todo Pago'
				),

				'password_dev' => array(
					'title'       => 'Password',
					'type'        => 'text',
					'description' => 'Password de Todo Pago'
				),
				...
				'titulo_testing' => array(
					...
					'type'        => 'title',
					'description' => 'Datos correspondientes al ambiente de desarrollo',
					'id'          => 'testing_options'
				),
				...
				'http_header_test' => array(
					'title'       => 'API Key',
					'type'        => 'text',
					'description' => "API Keys que se obtiene en el portal de Todo Pago.<br>Ejemplo: <b>TODOPAGO 912EC803B2CE49E4A541068D12345678</b>"
				),
				'security_test'    => array(
					'title'       => 'Security',
					'type'        => 'text',
					'description' => 'API Keys sin TODOPAGO. <br>Ejemplo: <b>912EC803B2CE49E4A541068D12345678</b>'
				),
